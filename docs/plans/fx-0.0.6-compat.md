...
- **0.0.6 default model** → `moonshotai/kimi-k3` (+Fast mode) — `fx status --json` confirms `"model":"moonshotai/kimi-k3"`. Our `DEFAULT_MODEL.fx = zai/glm-5.2-fast` hinted "fx's own default" is false.
