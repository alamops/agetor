...
| File | Count |
| --- | --- |
| `src/shared/pipeline.test.ts` | 119 |
| `src/bun/pipelines.test.ts` | 25 |
| `src/bun/pipelines-endpoint.test.ts` | 51 |
| `src/bun/pipeline-runner.test.ts` | 21 |
| `src/mainview/lib/pipelines.test.ts` | 41 |
| `src/cli/commands/pipeline.test.ts` | 72 |
| `e2e/pipelines-editor.spec.ts` | 5 |
| `e2e/pipelines-run.spec.ts` | 6 |

(These count `test(`/`it(` call sites, not necessarily unique assertions — several are table-driven and expand into more cases at runtime.)
