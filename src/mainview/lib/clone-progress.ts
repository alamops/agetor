 ...
 *  the terminal-cleanup delay instead of sleeping the real 5s, and reset the
 *  module's state between runs (the map is module-level and `bun test` runs
