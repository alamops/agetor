...
import m028 from "./028_kimi_harness.sql" with { type: "text" };
import m029 from "./029_kimi_session_id.sql" with { type: "text" };
...
export const migrations: Migration[] = [
  ...
  { id: "028_kimi_harness", sql: m028 },
  { id: "029_kimi_session_id", sql: m029 },
];
