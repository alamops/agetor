...
test("runs.eventsForTask merges events across runs in event-id (chronological) order", async () => {
  ...
  runs.insert({
    ...
    tmuxSession: "agetor-test-a", claudeSessionId: null, codexSessionId: null, kimiSessionId: null,
  });
  ...
  runs.insert({
    ...
    tmuxSession: "agetor-test-b", claudeSessionId: null, codexSessionId: null, kimiSessionId: null,
  });
...
test("sendInput on a finished claude-code task inserts a NEW run row with status='running'", async () => {
  ...
  runs.insert({
    ...
    tmuxSession: null, claudeSessionId: "fake-session-id", codexSessionId: null, kimiSessionId: null,
  });
